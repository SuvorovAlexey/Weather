...
let toSwitch = (props) => {
  ...
  //кнопка ветер
  if (btn[0].classList.value == "switch-btn switch-on") {
  ...
  else if (btn[0].classList.value == "switch-btn") {
  ...
  //кнопка дождь
  if (btn[1].classList.value == "switch-btn switch-on") {
  ...
  else if (btn[1].classList.value == "switch-btn") {
  ...
  //кнопка снег
  if (btn[2].classList.value == "switch-btn switch-on") {
  ...
  else if (btn[2].classList.value == "switch-btn") {
  ...
  //кнопка метель
  if (btn[3].classList.value == "switch-btn switch-on") {
  ...
  else if (btn[3].classList.value == "switch-btn") {
  ...
  //кнопка град
  if (btn[4].classList.value == "switch-btn switch-on") {
  ...
  else if (btn[4].classList.value == "switch-btn") {
  ...
  //кнопка гололед
  if (btn[5].classList.value == "switch-btn switch-on") {
  ...
  else if (btn[5].classList.value == "switch-btn") {
  ...
  //кнопка мороз
  if (btn[6].classList.value == "switch-btn switch-on") {
  ...
  else if (btn[6].classList.value == "switch-btn") {
